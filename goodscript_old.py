            ...
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if (diff_time >= 0.2):
                    ...
                    if (keypoint_classifier_labels[hand_sign_id] == "Move"):
                            ...
                            #if (sent_msg == ""):
                            #    sent_msg = "Frame"
                    if (keypoint_classifier_labels[hand_sign_id] == "Fist"):
                        sent_msg = "Stop"
                    if (keypoint_classifier_labels[hand_sign_id] == "Cue"):
                        sent_msg = "Camera rolling"
                    #print(sent_msg)
                    prev_time = cur_time
...
def define_direction_y(prev_area, area):
    ...
    area_over_distance = 0.0006 * prev_area - 0.0342
    distance_over_area = 1 / area_over_distance
    #print("y")
    y_velocity = a_velocity * distance_over_area * 0.001
